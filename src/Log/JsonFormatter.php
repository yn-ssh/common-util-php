 ...
 *
 * 输出示例：
 * {"time":"2026-07-01 12:00:00","level_name":"INFO","service":"spms-auth","server_ip":"172.18.0.3","server_port":"8781","request_id":"a1b2c3d4","user_id":"1001","client_ip":"203.0.113.5","app_id":"wx123456","message":"登录成功","context":{...}}
 */
class JsonFormatter extends MonologJsonFormatter
{
    public function format(array $record): string
    {
        ...
        $extra = array_diff_key(
            $record['extra'] ?? [],
            array_flip(['service', 'server_ip', 'server_port', 'request_id', 'user_id', 'client_ip', 'app_id'])
        );
        if (!empty($extra)) {
